...
set "appname=VPBase.Module.CRM.CCI.PROD"
set "giturl=https://vpgitdeploy:0UzwCUH5XD6jW54QaoFX@web-ccicrm-client-prod.scm.azurewebsites.net:443/web-ccicrm-client-prod.git"
