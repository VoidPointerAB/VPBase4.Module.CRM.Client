...
import { translateServerError, getDefaultError } from './errorTranslator';

export function genericErrorToast(content?: any) {
    toast.error(() => content ? content : GenericErrorMessage);
}
