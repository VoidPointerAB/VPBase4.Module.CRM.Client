...
echo In serverProjectPath=%serverProjectPath% environmentName=%environmentName% environmentMode=%environmentMode% ignorePauseInBuild=%ignorePauseInBuild% runDeployFileName=%runDeployFileName% publishProfile=%publishProfile%

echo.
echo *******************************************************************
echo *   VPBase Distribution Template Build Started v1.2
echo *
...
if defined publishProfile goto :start
...
dotnet publish %serverProjectPath% /p:PublishProfile=%publishProfile% /p:EnvironmentName=%environmentName% -o dist\\%dirname%
